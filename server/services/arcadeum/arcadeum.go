...
// TimestampSubkeyXXX is a free data retrieval call binding the contract method 0x798d6e48.
//
// Solidity: function timestampSubkeyXXX(game address, matchID uint32, timestamp uint256, timestampV uint8, timestampR bytes32, timestampS bytes32) constant returns(address)
func (_Arcadeum *ArcadeumCaller) TimestampSubkeyXXX(opts *bind.CallOpts, game common.Address, matchID uint32, timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte) (common.Address, error) {
	var (
		ret0 = new(common.Address)
	)
	out := ret0
	err := _Arcadeum.contract.Call(opts, out, "timestampSubkeyXXX", game, matchID, timestamp, timestampV, timestampR, timestampS)
	return *ret0, err
}
...
//
// Solidity: function timestampSubkeyXXX(game address, matchID uint32, timestamp uint256, timestampV uint8, timestampR bytes32, timestampS bytes32) constant returns(address)
func (_Arcadeum *ArcadeumSession) TimestampSubkeyXXX(game common.Address, matchID uint32, timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte) (common.Address, error) {
	return _Arcadeum.Contract.TimestampSubkeyXXX(&_Arcadeum.CallOpts, game, matchID, timestamp, timestampV, timestampR, timestampS)
}

// TimestampSubkeyXXX is a free data retrieval call binding the contract method 0x798d6e48.
//
// Solidity: function timestampSubkeyXXX(game address, matchID uint32, timestamp uint256, timestampV uint8, timestampR bytes32, timestampS bytes32) constant returns(address)
func (_Arcadeum *ArcadeumCallerSession) TimestampSubkeyXXX(game common.Address, matchID uint32, timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte) (common.Address, error) {
	return _Arcadeum.Contract.TimestampSubkeyXXX(&_Arcadeum.CallOpts, game, matchID, timestamp, timestampV, timestampR, timestampS)
}
