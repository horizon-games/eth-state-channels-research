...
func (_Arcadeum *ArcadeumCaller) CanStopWithdrawalXXX(opts *bind.CallOpts, timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte, subkeyV uint8, subkeyR [32]byte, subkeyS [32]byte) (bool, error) {
	...
	out := ret0
	err := _Arcadeum.contract.Call(opts, out, "canStopWithdrawalXXX", timestamp, timestampV, timestampR, timestampS, subkeyV, subkeyR, subkeyS)
	return *ret0, err
}
...
func (_Arcadeum *ArcadeumSession) CanStopWithdrawalXXX(timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte, subkeyV uint8, subkeyR [32]byte, subkeyS [32]byte) (bool, error) {
	return _Arcadeum.Contract.CanStopWithdrawalXXX(&_Arcadeum.CallOpts, timestamp, timestampV, timestampR, timestampS, subkeyV, subkeyR, subkeyS)
}
...
func (_Arcadeum *ArcadeumCaller) CouldStopWithdrawalXXX(opts *bind.CallOpts, timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte, subkeyV uint8, subkeyR [32]byte, subkeyS [32]byte) (bool, error) {
	...
	out := ret0
	err := _Arcadeum.contract.Call(opts, out, "couldStopWithdrawalXXX", timestamp, timestampV, timestampR, timestampS, subkeyV, subkeyR, subkeyS)
	return *ret0, err
}
...
func (_Arcadeum *ArcadeumSession) CouldStopWithdrawalXXX(timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte, subkeyV uint8, subkeyR [32]byte, subkeyS [32]byte) (bool, error) {
	return _Arcadeum.Contract.CouldStopWithdrawalXXX(&_Arcadeum.CallOpts, timestamp, timestampV, timestampR, timestampS, subkeyV, subkeyR, subkeyS)
}
...
// MatchHash is a free data retrieval call binding the contract method 0xfdf5087f.
//
// Solidity: function matchHash(game address, timestamp uint256, accounts address[2], subkeys address[2], seedRatings uint32[2], publicSeeds bytes[2]) constant returns(bytes32)
func (_Arcadeum *ArcadeumCaller) MatchHash(opts *bind.CallOpts, game common.Address, timestamp *big.Int, accounts [2]common.Address, subkeys [2]common.Address, seedRatings [2]uint32, publicSeeds [2][]byte) ([32]byte, error) {
	var (
		ret0 = new([32]byte)
	)
	out := ret0
	err := _Arcadeum.contract.Call(opts, out, "matchHash", game, timestamp, accounts, subkeys, seedRatings, publicSeeds)
	return *ret0, err
}
...
//
// Solidity: function matchHash(game address, timestamp uint256, accounts address[2], subkeys address[2], seedRatings uint32[2], publicSeeds bytes[2]) constant returns(bytes32)
func (_Arcadeum *ArcadeumSession) MatchHash(game common.Address, timestamp *big.Int, accounts [2]common.Address, subkeys [2]common.Address, seedRatings [2]uint32, publicSeeds [2][]byte) ([32]byte, error) {
	return _Arcadeum.Contract.MatchHash(&_Arcadeum.CallOpts, game, timestamp, accounts, subkeys, seedRatings, publicSeeds)
}

// MatchHash is a free data retrieval call binding the contract method 0xfdf5087f.
//
// Solidity: function matchHash(game address, timestamp uint256, accounts address[2], subkeys address[2], seedRatings uint32[2], publicSeeds bytes[2]) constant returns(bytes32)
func (_Arcadeum *ArcadeumCallerSession) MatchHash(game common.Address, timestamp *big.Int, accounts [2]common.Address, subkeys [2]common.Address, seedRatings [2]uint32, publicSeeds [2][]byte) ([32]byte, error) {
	return _Arcadeum.Contract.MatchHash(&_Arcadeum.CallOpts, game, timestamp, accounts, subkeys, seedRatings, publicSeeds)
}
...
func (_Arcadeum *ArcadeumCaller) PlayerAccountXXX(opts *bind.CallOpts, timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte, subkeyV uint8, subkeyR [32]byte, subkeyS [32]byte) (common.Address, error) {
	...
	out := ret0
	err := _Arcadeum.contract.Call(opts, out, "playerAccountXXX", timestamp, timestampV, timestampR, timestampS, subkeyV, subkeyR, subkeyS)
	return *ret0, err
}
...
func (_Arcadeum *ArcadeumSession) PlayerAccountXXX(timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte, subkeyV uint8, subkeyR [32]byte, subkeyS [32]byte) (common.Address, error) {
	return _Arcadeum.Contract.PlayerAccountXXX(&_Arcadeum.CallOpts, timestamp, timestampV, timestampR, timestampS, subkeyV, subkeyR, subkeyS)
}
...
func (_Arcadeum *ArcadeumCaller) WithdrawalTime(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	...
	out := ret0
	err := _Arcadeum.contract.Call(opts, out, "withdrawalTime", arg0)
	return *ret0, err
}
...
func (_Arcadeum *ArcadeumSession) WithdrawalTime(arg0 common.Address) (*big.Int, error) {
	return _Arcadeum.Contract.WithdrawalTime(&_Arcadeum.CallOpts, arg0)
}
...
func (_Arcadeum *ArcadeumTransactor) StopWithdrawalXXX(opts *bind.TransactOpts, timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte, subkeyV uint8, subkeyR [32]byte, subkeyS [32]byte) (*types.Transaction, error) {
	return _Arcadeum.contract.Transact(opts, "stopWithdrawalXXX", timestamp, timestampV, timestampR, timestampS, subkeyV, subkeyR, subkeyS)
}
...
func (_Arcadeum *ArcadeumSession) StopWithdrawalXXX(timestamp *big.Int, timestampV uint8, timestampR [32]byte, timestampS [32]byte, subkeyV uint8, subkeyR [32]byte, subkeyS [32]byte) (*types.Transaction, error) {
	return _Arcadeum.Contract.StopWithdrawalXXX(&_Arcadeum.TransactOpts, timestamp, timestampV, timestampR, timestampS, subkeyV, subkeyR, subkeyS)
}
...
func (_Arcadeum *ArcadeumFilterer) FilterRewardClaimed(opts *bind.FilterOpts, account []common.Address, subkey []common.Address, timestamp []*big.Int) (*ArcadeumRewardClaimedIterator, error) {
	...
	logs, sub, err := _Arcadeum.contract.FilterLogs(opts, "rewardClaimed", accountRule, subkeyRule, timestampRule)
	if err != nil {
		return nil, err
	}
...
func (_Arcadeum *ArcadeumFilterer) WatchRewardClaimed(opts *bind.WatchOpts, sink chan<- *ArcadeumRewardClaimed, account []common.Address, subkey []common.Address, timestamp []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Arcadeum.contract.WatchLogs(opts, "rewardClaimed", accountRule, subkeyRule, timestampRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
