...
// MatchHash is a free data retrieval call binding the contract method 0xec0ae340.
//
// Solidity: function matchHash(game address, timestamp uint256, accounts address[2], subkeys address[2], seedRatings uint32[2], publicSeeds bytes32[1][2]) constant returns(bytes32)
func (_Arcadeum *ArcadeumCaller) MatchHash(opts *bind.CallOpts, game common.Address, timestamp *big.Int, accounts [2]common.Address, subkeys [2]common.Address, seedRatings [2]uint32, publicSeeds [2][1][32]byte) ([32]byte, error) {
	var (
		ret0 = new([32]byte)
	)
	out := ret0
...
//
// Solidity: function matchHash(game address, timestamp uint256, accounts address[2], subkeys address[2], seedRatings uint32[2], publicSeeds bytes32[1][2]) constant returns(bytes32)
func (_Arcadeum *ArcadeumSession) MatchHash(game common.Address, timestamp *big.Int, accounts [2]common.Address, subkeys [2]common.Address, seedRatings [2]uint32, publicSeeds [2][1][32]byte) ([32]byte, error) {
...
//
// Solidity: function matchHash(game address, timestamp uint256, accounts address[2], subkeys address[2], seedRatings uint32[2], publicSeeds bytes32[1][2]) constant returns(bytes32)
func (_Arcadeum *ArcadeumCallerSession) MatchHash(game common.Address, timestamp *big.Int, accounts [2]common.Address, subkeys [2]common.Address, seedRatings [2]uint32, publicSeeds [2][1][32]byte) ([32]byte, error) {
	return _Arcadeum.Contract.MatchHash(&_Arcadeum.CallOpts, game, timestamp, accounts, subkeys, seedRatings, publicSeeds)
}
